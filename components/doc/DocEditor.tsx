...
import { Loader2, Cloud, Sparkles, Users, Share2, MessageSquare, Menu, Lock, Globe, FileText, ChevronLeft, ChevronRight, ArrowLeft } from 'lucide-react';
...
export const DocEditor: React.FC<Props> = ({ 
  ...
  useEffect(() => {
    ...
    const checkCursorPage = () => {
        // Usa requestAnimationFrame para garantir que o DOM já foi redesenhado (reflow)
        // Isso evita leituras incorretas de offsetTop=0 durante a inserção de caracteres
        requestAnimationFrame(() => {
            ...
            try {
                ...
                if (element) {
                    ...
                    // SAFETY CHECK: Se estamos muito à frente no documento (> 2000 chars) mas
                    // o cálculo diz "Página 1", provavelmente é um erro de leitura do DOM antes do paint.
                    // Ignora para evitar pulo.
                    if (from > 2000 && calculatedPage === 1) return;
