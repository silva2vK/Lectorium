                    ...
                    >
                        ...
                        <div className="absolute inset-0 pointer-events-none z-0">
                            {pageLayout.pages.map((page: any, i: number) => {
                                ...
                                // Priority Rendering: Se for a página ativa, remove a otimização de content-visibility
                                const isPageActive = (i + 1) === currentPage;

                                return (
                                    <div 
                                      key={i} 
                                      className={`absolute left-0 w-full ${isPageActive ? '' : 'native-page-contain'}`}
                                      style={{ 
                                          top: topPos, 
                                          height: page.heightPx,
                                          containIntrinsicSize: `auto ${page.heightPx}px`
                                      }}
                                    >
