  ...
  return (
    ...
    >
       ...
       {isMobile && (
         ...
         >
            <div className="bg-black border-b border-x border-brand/50 shadow-[0_5px_20px_-5px_rgba(0,0,0,0.8)] rounded-b-2xl px-6 py-1.5 transition-all duration-300 hover:pt-3 hover:pb-2 group flex items-center justify-center">
