      ...
      <div className="relative z-10 h-full overflow-y-auto p-4 md:p-12 custom-scrollbar">
          <div className="mb-6 md:mb-10 flex flex-wrap justify-between items-center gap-4">
            <button 
                ...
                className="p-3 -ml-3 text-white bg-black border-2 border-brand/40 rounded-2xl transition-all hover:bg-[#111] hover:border-brand hover:shadow-[0_0_15px_-5px_var(--brand)] active:scale-95 shadow-2xl"
                title="Abrir Menu"
            >
            ...
            <div className="flex items-center gap-2 md:gap-3 flex-wrap">
                {onToggleSyncStrategy && (
                    <div className="flex bg-black p-1.5 rounded-2xl border border-white/35">
                        <button 
                ...
                <button 
                    ...
                    className={`flex items-center gap-2 px-3 md:px-4 py-2.5 bg-black border rounded-2xl text-sm font-bold transition-all active:scale-95 ${
                ...
                <button onClick={openStorageModal} className="flex items-center gap-2 px-3 md:px-4 py-2.5 bg-black border border-white/35 rounded-2xl text-white hover:text-white transition-all text-sm font-bold active:scale-95">
