...
import { AlertCircle, X, FileText, Lock, Hash, Copy, ScrollText, Palette, Droplets, BookOpen, SplitSquareHorizontal, LayoutTemplate, Binary, ScanLine, Pen, Highlighter, MessageSquare, Sparkles } from 'lucide-react';
