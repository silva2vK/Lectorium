...
import { AlertCircle, X, FileText, Lock, Hash, Copy, ScrollText, Palette, Droplets, BookOpen, SplitSquareHorizontal, LayoutTemplate, Binary, ScanLine, Pen, Highlighter, MessageSquare } from 'lucide-react';
